// NpcServer.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BOOL CNpcServerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CNpcServerDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CNpcServerView));
	if (!pDocTemplate)
		return FALSE;
